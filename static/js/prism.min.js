  ...
  Prism = function (o) {
    var u = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      j = {
        ...
        disableWorkerMessageHandler: o.Prism &&
          o.Prism.disableWorkerMessageHandler,
        util: {
          encode: function e(t) {
              ...
              t.hasOwnProperty(s) &&
                (n.call(t, s, t[s], a || s),
                  ...
                  "Object" !== (l = j.util.type(i)) || r[o(i)]
                    ? "Array" !== l || r[o(i)] || (r[o(i)] = !0, e(i, n, s, r))
        ...
        highlightElement: function (e, t, n) {
          var a = j.util.getLanguage(e), r = j.languages[a];
          e.className = e.className.replace(u, "").replace(/\s+/g, " ") +
            " language-" + a;
          var s = e.parentElement;
          s && "pre" === s.nodeName.toLowerCase() &&
            (s.className = s.className.replace(u, "").replace(/\s+/g, " ") +
              " language-" + a);
              ...
              for (var l in a) {
                if (a.hasOwnProperty(l) && a[l]) {
                  ...
                  for (var u = 0; u < o.length; ++u) {
                    ...
                    for (
                      var f = c.pattern || c, y = r.next, b = s;
                      y !== n.tail && !(i && b >= i.reach);
                      ...
                      if (!(v instanceof C)) {
                        var F, k = 1;
                        if (m) {
                          if (!(F = O(f, b, t, p))) break;
                          var x = F.index, w = F.index + F[0].length, A = b;
                          for (A += y.value.length; A <= x;) {
                            y = y.next, A += y.value.length;
                          }
                          if (
                            A -= y.value.length, b = A, y.value instanceof C
                          ) continue;
                          for (
                            var P = y;
                            P !== n.tail &&
                            (A < w || "string" == typeof P.value);
                            P = P.next
                          ) k++, A += P.value.length;
                          k--, v = t.slice(b, A), F.index -= b;
                        ...
                        var v = y.prev;
                        S && (v = z(n, v, S), b += S.length), T(n, v, k);
                        var $ = new C(l, d ? j.tokenize($, d) : $, h, $);
                        y = z(n, v, $),
                          E && z(n, y, E),
                          1 < k &&
                          e(t, n, a, y.prev, b, {
    ...
    function z(e, t, n) {
      var a = t.next, n = { value: n, prev: t, next: a };
      ...
      o.Prism = j,
        C.stringify = function t(e, n) {
          ...
          e && (Array.isArray(e)
            ...
            : r.classes.push(e)), j.hooks.run("wrap", r);
          var s, i = "";
          for (s in r.attributes) {
            i += " " + s + '="' +
              (r.attributes[s] || "").replace(/"/g, "&quot;") + '"';
          }
          return "<" + r.tag + ' class="' + r.classes.join(" ") + '"' + i +
            ">" + r.content + "</" + r.tag + ">";
        },
        !o.document
    ) {
    ...
    var e, n = j.util.currentScript();
    function a() {
      j.manual || j.highlightAll();
    }
    return n &&
      (j.filename = n.src, n.hasAttribute("data-manual") && (j.manual = !0)),
      j.manual ||
...
"undefined" != typeof module && module.exports && (module.exports = Prism),
  ...
  function () {
    ...
    "undefined" != typeof self && self.Prism && self.document &&
      (Element.prototype.matches ||
        ...
        g = "pre[data-src]:not([" + (o = "data-src-status") +
          '="loaded"]):not([' + o + '="' + (u = "loading") + '"])',
        a = /\blang(?:uage)?-([\w-]+)\b/i,
        ...
        i.hooks.add("before-sanity-check", function (e) {
          ...
          s.matches(g) &&
            (e.code = "",
              s.setAttribute(o, u),
              (t = s.appendChild(document.createElement("CODE"))).textContent =
                "Loading…",
              n = s.getAttribute("data-src"),
              "none" === (e = e.language) &&
              (a = (/\.(\w+)$/.exec(n) || [, "none"])[1], e = l[a] || a),
              c(t, e),
              c(s, e),
                ...
                4 == r.readyState &&
                  (r.status < 400 && r.responseText
                    ...
                    : (s.setAttribute(o, "failed"),
                      400 <= r.status
                        ? t.textContent = "✖ Error " + r.status +
                          " while fetching file: " + r.statusText
                        : t.textContent =
        ...
        i.fileHighlight = function () {
          ...
          (console.warn(
            ...
            e = !0), i.plugins.fileHighlight.highlight.apply(this, arguments);
        });
  }();
